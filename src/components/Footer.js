...
const Footer = () => {
  return (
    <div className="h-24 w-full bottom-0 bg-s-black">
      <div className="flex flex-col h-full justify-center p-5 md:flex-row md:justify-between items-center">
          <p className="text-sm text-center md:text-base text-gray-500">&copy; 2021 Lynfield College Robotics. All rights reserved</p>
          {/* <div className="inline flex mt-2">
            <a href="https://www.facebook.com/lynfieldrobotics" target="new"><img src={FBIcon} alt="Facebook Icon" className="h-8 w-auto pr-2 fill-current"/></a>
