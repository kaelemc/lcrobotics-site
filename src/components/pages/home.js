    ...
    return (
        ...
        <main className="max-w-screen-xl mx-auto">
            ...
            <div className="h-screen relative flex items-center md:max-w-screen md:h-auto md:justify-center">
                    ...
                    <div className="absolute mx-5 font-bold text-3xl backdrop-filter md:text-6xl">
                        ...
                        <div className="mt-2 md:mt-0">
                            <button type="button" className="transition-all ease-in duration-75 bg-white text-blue-600 hover:bg-blue-100 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-3 mb-3 md:px-6 md:py-3.5">
                                Learn more
                            </button>
                        </div>
                    </div>
            ...
            <div className="mx-5 lg:mx-0">
                ...
                <p className="text-justify text-base md:text-left">{welcome_para}</p>
                        ...
                        quickStats.map((stat) => {
                            return(
                                ...
                                <div className="mt-8 md:mt-0">
                                    <h5 className="text-blue-600 font-bold text-2xl">{stat.stat}</h5>
            ...
            <div className="mx-5 lg:mx-0">
                ...
                <h1 className="py-10 text-3xl font-bold">Our Teams</h1>
                                ...
                                <div className="p-6 w-full bg-white rounded-lg border border-gray-200 hover:bg-gray-100">
                                    <div>
                                        <div className="flex mb-2 justify-between">
                                            <h5 className="text-xl font-bold tracking-tight text-gray-900">{team.teamName}</h5>
                                            {
                                                team.isIQ ? (
                                                    <span className="bg-blue-100 text-blue-800 text-sm font-medium mr-2 px-2.5 py-0.5 rounded self-center">IQ</span>
                                                ) : (
                                                    <span className="bg-red-100 text-red-800 text-sm font-medium mr-2 px-2.5 py-0.5 rounded self-center">VRC</span>
                                                )
                                            }
                                        </div>
            ...
            <div className="mx-5 lg:mx-0">
                ...
                <h1 className="py-10 text-3xl font-bold">Sponsors</h1>
